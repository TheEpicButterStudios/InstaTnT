...
public class Updater {
    ...
    private int id = 67156; // Project's Curse ID
    private String apiKey = "57a026419fb94876dfffa8fd7356c92855c5f866"; // BukkitDev ServerMods API key
    ...
    private static final String USER_AGENT = "InstaTnT Updater";
    private static final String delimiter = "^v|[\\s_-]v"; // Used for locating version numbers in file names
    private static final String[] NO_UPDATE_TAG = { "-DEV", "-PRE", "-SNAPSHOT", "SNAPSHOT", "DEV" }; // If the version number contains one of these, don't update.
